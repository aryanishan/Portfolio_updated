...
export const skillGroups = [
  {
    title: 'Frontend',
    icon: LayoutTemplate,
    boardLabel: 'Interface Systems',
    skills: [
      { name: 'HTML', level: 90, image: 'https://skillicons.dev/icons?i=html' },
      { name: 'CSS', level: 88, image: 'https://skillicons.dev/icons?i=css' },
      { name: 'React', level: 88, image: 'https://skillicons.dev/icons?i=react' },
      { name: 'JavaScript', level: 90, image: 'https://skillicons.dev/icons?i=javascript' },
      { name: 'TypeScript', level: 82, image: 'https://skillicons.dev/icons?i=typescript' },
      { name: 'Tailwind CSS', level: 86, image: 'https://skillicons.dev/icons?i=tailwind' },
      { name: 'Framer Motion', level: 75, image: 'https://cdn.simpleicons.org/framer/111111' },
    ],
  },
  {
    title: 'Backend',
    icon: Server,
    boardLabel: 'Service Layer',
    skills: [
      { name: 'Node.js', level: 87, image: 'https://skillicons.dev/icons?i=nodejs' },
      { name: 'Express.js', level: 85, image: 'https://skillicons.dev/icons?i=express' },
      { name: 'REST APIs', level: 88, badge: 'API' },
      { name: 'WebSockets', level: 72, badge: 'WS' },
      { name: 'FastAPI / Flask', level: 78, image: 'https://skillicons.dev/icons?i=fastapi' },
    ],
  },
  {
    title: 'Databases & Tools',
    icon: Wrench,
    boardLabel: 'Delivery Toolkit',
    skills: [
      { name: 'MongoDB', level: 80, image: 'https://skillicons.dev/icons?i=mongodb' },
      { name: 'MySQL', level: 82, image: 'https://skillicons.dev/icons?i=mysql' },
      { name: 'PostgreSQL', level: 74, image: 'https://skillicons.dev/icons?i=postgres' },
      { name: 'Docker', level: 68, image: 'https://skillicons.dev/icons?i=docker' },
      { name: 'Git', level: 90, image: 'https://skillicons.dev/icons?i=git' },
      { name: 'GitHub', level: 90, image: 'https://skillicons.dev/icons?i=github' },
    ],
  },
]
...
export const skillConstellations = [
  {
    title: 'Languages',
    eyebrow: 'Code Fluency',
    center: 'Language Universe',
    items: [
      { name: 'Python', image: 'https://skillicons.dev/icons?i=python' },
      { name: 'C++', image: 'https://skillicons.dev/icons?i=cpp' },
      { name: 'JavaScript', image: 'https://skillicons.dev/icons?i=javascript' },
      { name: 'TypeScript', image: 'https://skillicons.dev/icons?i=typescript' },
      { name: 'C', image: 'https://skillicons.dev/icons?i=c' },
      { name: 'Kotlin', image: 'https://skillicons.dev/icons?i=kotlin' },
  ...
  },
  {
    title: 'Core CS',
    eyebrow: 'Foundations',
    center: 'Computer Science Core',
    items: [
      { name: 'DSA', badge: 'DSA' },
      { name: 'OOP', badge: 'OOP' },
      { name: 'System Design', badge: 'SYS' },
      { name: 'Computer Networks', badge: 'NET' },
      { name: 'Operating Systems', badge: 'OS' },
      { name: 'DBMS', badge: 'DB' },
    ],
  },
  {
    ...
    center: 'Soft Skills',
    items: [
      { name: 'Communication', badge: 'COM' },
      { name: 'Teamwork', badge: 'TEAM' },
      { name: 'Problem Solving', badge: 'PS' },
      { name: 'Leadership', badge: 'LEAD' },
      { name: 'Adaptability', badge: 'ADPT' },
      { name: 'Time Management', badge: 'TIME' },
    ],
  },
]
...
export const quickFacts = [
  ...
  {
    label: 'Soft Skills',
    text: 'Communication, Teamwork, Problem Solving, Leadership, Adaptability, Time Management',
    icon: BadgeCheck,
  },
]
